  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-sunset': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #f5576c 75%, #4facfe 100%)',
        'gradient-ocean': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #4facfe 50%, #00f2fe 75%, #4facfe 100%)',
        'gradient-fire': 'linear-gradient(135deg, #fa709a 0%, #fee140 50%, #fa709a 100%)',
        'gradient-forest': 'linear-gradient(135deg, #a8edea 0%, #fed6e3 50%, #a8edea 100%)',
        'gradient-space': 'linear-gradient(135deg, #667eea 0%, #764ba2 25%, #f093fb 50%, #f5576c 75%, #4facfe 100%)',
      },
      animation: {
      ...
      boxShadow: {
        ...
        'neon': '0 0 5px #8b5cf6, 0 0 10px #8b5cf6, 0 0 15px #8b5cf6',
        'neon-lg': '0 0 10px #8b5cf6, 0 0 20px #8b5cf6, 0 0 30px #8b5cf6',
      },
      borderRadius: {
        '4xl': '2rem',
        '5xl': '2.5rem',
